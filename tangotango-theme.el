...
(custom-theme-set-faces
 ...
 `(default ((t (:family "Monaco" :foundry "unknown" :width normal :height 120 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#eeeeec" :background "#202424" :stipple nil :inherit nil))))
