...
;; use option as alt and command as meta (Also using configured caps lock to be CTRL and tapping it acts as escape (using Karabiner)
...
;; Save your minibuffer history across Emacs sessions. UX win!
(savehist-mode t)
